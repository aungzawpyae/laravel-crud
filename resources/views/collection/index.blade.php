          ...
          <tbody class="">
            ...
            <tr class=" ">
              ...
              <td class=" px-1 py-4 whitespace-nowrap   text-center text-sm font-medium ">
                 <div class='flex'>
                  <a href="{{route('collection.show',$collection->id)}}" class="pr-5 text-indigo-600 hover:text-indigo-900">Show</a>
                <a href="{{route('collection.edit',$collection->id)}}" class="pr-5 text-indigo-600 hover:text-indigo-900">Edit</a>
                <form action="{{route('collection.destroy',$collection->id)}}" method="post" class="">
                  @csrf
                  @method('DELETE')   
